...
ROLE_PERMISSIONS = {
    ...
    'branch_manager': {
        'default_modules': ['support', 
            ...
            'chat', 'notifications', 'audit_logs', 'settings', 'reimbursements',
        ],
        'canDelete': False,
        'canExport': True,
    },
    'admin_senior_executive': {
        'default_modules': ['support', 
            ...
            'payroll', 'settings', 'reimbursements',
        ],
        'canDelete': False,
        'canExport': True,
    },
    'admin_executive': {
        'default_modules': ['support', 
            ...
            'payroll', 'settings', 'notifications', 'leave', 'reimbursements',
        ],
        'canDelete': False,
        'canExport': False,
    },
    ...
    'counsellor': {
        'default_modules': ['support', 'crm', 'students', 'payroll', 'settings', 'attendance', 'notifications', 'leave', 'reimbursements'],
        'canDelete': False,
        'canExport': False,
    },
    'tele_caller': {
    ...
    'exam_supervisor': {
        'default_modules': ['support', 
            'attendance', 'exams', 'notifications', 'payroll', 'settings', 'leave', 'reimbursements',
        ],
        'canDelete': False,
        'canExport': False,
    },
    'paper_checker': {
        'default_modules': ['support', 
            'exams', 'notifications', 'payroll', 'settings', 'leave', 'reimbursements',
        ],
        'canDelete': False,
        'canExport': False,
    },
    'accountant': {
        'default_modules': ['support', 
            'attendance', 'fees', 'payroll', 'notifications', 'settings', 'leave', 'reimbursements',
        ],
        'canDelete': False,
        'canExport': True,
    },
...
URL_MODULE_MAP = [
    ...
    # Reimbursements
    (r'^api/v1/reimbursements?/', 'reimbursements'),
]
