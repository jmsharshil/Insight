...
from .views import (StudentListView,StudentDetailView,StudentSelfProfileView,StudentQRIdentityView,StudentStatusUpdateView,StudentBatchAllocateView,StudentDocumentUploadView,StudentInventoryView,)
