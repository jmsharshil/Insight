    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direct_hash', models.CharField(blank=True, default='', help_text="For direct rooms only: sorted user-UUID pair separated by '_' to guarantee uniqueness.", max_length=100, unique=True)),
