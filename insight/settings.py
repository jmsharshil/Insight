...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "support@insightinstitute.co")
...
WHATSAPP_VERIFY_TOKEN = os.environ.get("WHATSAPP_VERIFY_TOKEN", "123")
WHATSAPP_API_BASE_URL = os.environ.get("WHATSAPP_API_BASE_URL", "https://graph.facebook.com")
WHATSAPP_CRM_WEBHOOK_URL = os.environ.get("WHATSAPP_CRM_WEBHOOK_URL", "")
