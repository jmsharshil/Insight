...
class SchedulerConfig(AppConfig):
    ...
    def _register_tasks(self):
        ...
        from leads.tasks import send_sales_plan_reminders, send_custom_sales_plan_reminders, auto_start_sales_activities
        TaskScheduler.register("send_sales_plan_reminders", send_sales_plan_reminders)
        TaskScheduler.register("send_custom_sales_plan_reminders", send_custom_sales_plan_reminders)
        TaskScheduler.register("auto_start_sales_activities", auto_start_sales_activities)
    ...
    def _ensure_recurring_tasks(self):
        ...
        RECURRING_TASKS = [
            ...
            {
                "task_type": "send_custom_sales_plan_reminders",
                "interval_seconds": 60,          # every 1 minute
                "delay_seconds": 60,             # 1 min after startup
                "max_retries": 3,
            },
            {
                "task_type": "auto_start_sales_activities",
                "interval_seconds": 60,          # every 1 minute
                "delay_seconds": 60,             # 1 min after startup
                "max_retries": 3,
            },
