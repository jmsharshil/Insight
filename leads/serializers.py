...
class LeadListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
         ...
         'course_display', 'group_module_display', 'batch_attempt_display', 'current_stage_display', 'qualification_display', 'reference_display', 'tenth_medium_display', 'twelfth_medium_display', 'stage_display']
