...
from .views import (
    ...
    SalesDailyActivityView, SalesDailyActivityCompleteView, SalesActivityPhotoView,
...
urlpatterns = [
    ...
    path("sales/activities/<uuid:activity_id>/complete/", SalesDailyActivityCompleteView.as_view(), name="sales-activity-complete"),
    ...
    # User seminar & fair statistics
    path("sales/users/<uuid:user_id>/stats/", SalesUserActivityStatsView.as_view(), name="sales-user-activity-stats"),
]
